...
for val in test_set:
    shutil.copyfile(str(os.path.dirname(os.getcwd())) + '/seg_data/' + str(val) + '_segmented.png',
                    str(os.path.dirname(os.getcwd())) + '/Data/test_data/' + str(val) + '_segmented.png')
for val in train_set:
    shutil.copyfile(str(os.path.dirname(os.getcwd())) + '/seg_data/' + str(val) + '_segmented.png',
                    str(os.path.dirname(os.getcwd())) + '/Data/train_data/' + str(val) + '_segmented.png')
    img = np.array(Image.open(str(os.path.dirname(os.getcwd())) + '/resized_mapillary/' + str(val) + '.jpg').convert('RGB'))
