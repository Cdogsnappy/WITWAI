...
data_size = 70
if os.path.exists(str(os.getcwd()) + '/Data/test_data'):
    shutil.rmtree(str(os.getcwd()) + '/Data/test_data')
if os.path.exists(str(os.getcwd()) + '/Data/train_data'):
    shutil.rmtree(str(os.getcwd()) + '/Data/train_data')
if os.path.exists(str(os.getcwd()) + '/Data/used_countries.csv'):
    os.remove(str(os.getcwd()) + '/Data/used_countries.csv')
...
g = open(str(os.getcwd()) + '/Data/used_countries.csv', 'w')
g.write('country\n')
...
for val in test_set:
    shutil.copyfile(str(os.getcwd()) + '/seg_data/' + str(int(val)) + '_segmented.png',
                    str(os.getcwd()) + '/Data/test_data/' + str(int(val)) + '_segmented.png')
for val in train_set:
    shutil.copyfile(str(os.getcwd()) + '/seg_data/' + str(int(val)) + '_segmented.png',
                    str(os.getcwd()) + '/Data/train_data/' + str(int(val)) + '_segmented.png')
    img = np.array(Image.open(str(os.getcwd()) + '/resized_mapillary/' + str(int(val)) + '.jpg').convert('RGB'))
